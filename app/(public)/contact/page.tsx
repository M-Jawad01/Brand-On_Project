            ...
            <div className="bg-brand-secondary p-8 rounded-lg">
              ...
              <form className="space-y-6">
                ...
                <div>
                  ...
                  <select
                    required
                    className="w-full px-4 py-3 bg-brand-base border border-brand-accent rounded-lg text-white focus:outline-none focus:border-brand-primary"
                  >
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-gray-300 mb-8">
                  Feel free to reach out to us through any of the following channels. Our team is here to help you with all your advertising needs.
                </p>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="bg-brand-secondary p-6 rounded-lg flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-400 mt-1">Quick responses</p>
                  </div>
                </div>
                ...
                <div className="bg-brand-secondary p-6 rounded-lg flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-400 mt-1">{companyInfo.businessHours}</p>
                  </div>
                </div>
              </div>
