...
export default function ServiceCard({ service }: ServiceCardProps) {
  return (
    <Link href={`/services/${service.id}`}>
      <div className="bg-brand-secondary-light rounded-lg overflow-hidden hover:shadow-xl hover:shadow-brand-primary/30 transition-all duration-300 group h-full border border-brand-accent-dark/30">
        {/* Service Image */}
        <div className="relative h-64 bg-brand-accent-light overflow-hidden">
          <div className="absolute inset-0 bg-gradient-to-t from-brand-base-light/90 to-transparent z-10"></div>
