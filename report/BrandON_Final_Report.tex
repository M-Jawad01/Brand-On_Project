...
\textit{Given} the customer is on the order form and enters width = 4 ft, height = 3 ft, material = Vinyl (\PKR15/sqft), quantity = 2,
\textit{then} the total price displayed is $4 \times 3 \times 15 \times 2 = \PKR360$.
,
...
Google Drive (Deliverables) & \textit{[Provide final Google Drive link here]} \\
Demo Video & \textit{[Provide final demo video link here]} \\
Client Feedback Video & \textit{[Provide client feedback recording link here]} \\
\bottomrule
\end{tabularx}
\end{table}
